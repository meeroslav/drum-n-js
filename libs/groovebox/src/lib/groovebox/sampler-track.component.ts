...
import { ROMPLER_NAMES, ROMPLER_SAMPLES, SamplerTrack, SynthNote, TrackBase } from '@drum-n-js/audio-utils';
  ...
  <div class="grid grid-col-1 space-y-1">
    <div class="flex items-center space-x-2 mb-1">
      ...
      <select
        ...
        <option *ngFor="let sound of SAMPLE_NAMES" [value]="sound">{{ SAMPLES[sound].name }}</option>
      </select>
...
export class SamplerTrackComponent {
  ...
  SAMPLE_NAMES: Array<keyof typeof ROMPLER_SAMPLES> = ROMPLER_NAMES;
