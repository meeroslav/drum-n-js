...
import { DrumTrack, SynthTrack } from './sequencer';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, DrumTrackComponent, SynthTrackComponent],
...
export class SequencerTrackComponent {
  track = input.required<DrumTrack | SynthTrack>();
  ...
  isSynth(track: DrumTrack | SynthTrack): track is SynthTrack {
